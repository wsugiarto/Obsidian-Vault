...
- Problems:
	...
	- [Counting Bits](https://leetcode.com/problems/counting-bits/)
		- This is dynamic programming, you can see the pattern if you draw out the bits from 1-n
			- Its just `1 + dp[i-offset]`, where offset is the most significant bit we've reach (1,2,8,16, ...)
			```python
			class Solution:
